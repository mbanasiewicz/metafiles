...
from search_logic.SearchDocuments import *

searchEngine = SearchDocumets([text1, text2, text3, text4, text5])
print searchEngine.search("spokojny pies")

# # remove all unwanted chars, lower them
# texts = [x.translate(None, string.punctuation + "–").lower() for x in [text1, text2, text3, text4, text5]]
